...
{
/*
var audio = new Audio('barchartmusic.mp3');
audio.play();*/
...
*/
            $.ajax(
            {
                    url  : "https://api.covid19india.org/v4/timeseries-MH.json",
                    contentType: "application/json",
                    type : 'GET',
                    contentType: false,
                    cache: false,
                    ...
                    success: function(response)
                    {
                       // console.log(response);
                        ...
                        var dates = response.MH.districts.Mumbai.dates;

                        const keys = Object.keys(dates);
                        Object.entries(dates).forEach(([key, value]) => {
                              var   days = calculateDay(key);
                              var   newarray = [];
                              var   name =   'Mumbai';
                              if( clicked_id == 'buttonConfirmed')
                              {
                              var  count=  value.total.confirmed;
                              }
                              else if ( clicked_id == 'buttonDeaths')
                              {
                              var  count=   value.total.deceased;
                              }
                              else if (clicked_id == 'buttonRecovered')
                              {
                              var  count=   value.total.recovered;
                              }
                              else if (clicked_id == 'buttonActive')
                              {
                              var  count=   value.total.confirmed- value.total.recovered- value.total.deceased;
                              }
                              var   objC = {name,count};
                              newarray = arrAllCities[days];
                              newarray.push(objC);
                            ...
                            var dates = response.MH.districts.Pune.dates;

                        const keys1 = Object.keys(dates);
                        Object.entries(dates).forEach(([key, value]) => {
                              var   days = calculateDay(key);
                              var   newarray = [];
                              var   name =   'Pune';
                            ...
                            var dates = response.MH.districts.Thane.dates;

                         const keys2 = Object.keys(dates);
                         Object.entries(dates).forEach(([key, value]) => {
                              var   days = calculateDay(key);
                              var   newarray = [];
                              var   name =   'Thane';
                       ...
                       $.ajax(
                            {
                            url  : "https://api.covid19india.org/v4/timeseries-DL.json",
                            contentType: "application/json",
                            type : 'GET',
                            contentType: false,
                            cache: false,
                            ...
                            {
                                //console.log(response);
                                var dates = response.DL.districts.Delhi.dates;

                                const keys3 = Object.keys(dates);
                                Object.entries(dates).forEach(([key, value]) => {
                              var   days = calculateDay(key);
                              var   newarray = [];
                              var   name =   'Delhi';
                       ...
                       $.ajax(
                            {
                            url  : "https://api.covid19india.org/v4/timeseries-TN.json",
                            contentType: "application/json",
                            type : 'GET',
                            contentType: false,
                            cache: false,
                            ...
                            {
                                //console.log(response);
                                var dates = response.TN.districts.Chennai.dates;

                                const keys4 = Object.keys(dates);
                                Object.entries(dates).forEach(([key, value]) => {
                              var   days = calculateDay(key);
                              var   newarray = [];
                              var   name =   'Chennai';
                       ...
                       $.ajax(
                            {
                            url  : "https://api.covid19india.org/v4/timeseries-KA.json",
                            contentType: "application/json",
                            type : 'GET',
                            contentType: false,
                            cache: false,
                            ...
                            {
                                //console.log(response);
                                var dates = response.KA.districts["Bengaluru Urban"].dates;
                       ...
                       $.ajax(
                            {
                            url  : "https://api.covid19india.org/v4/timeseries-GJ.json",
                            contentType: "application/json",
                            type : 'GET',
                            contentType: false,
                            cache: false,
                            ...
                            {
                               // console.log(response);
                                var dates = response.GJ.districts.Ahmedabad.dates;
                       ...
                       $.ajax(
                            {
                            url  : "https://api.covid19india.org/v4/timeseries-WB.json",
                            contentType: "application/json",
                            type : 'GET',
                            contentType: false,
                            cache: false,
                            ...
                            {
                                //console.log(response);
                                var dates = response.WB.districts.Kolkata.dates;
